  ...
  return (
    <div className="h-full w-full flex items-center justify-center">
      <div className="flex flex-col items-center justify-start gap-2 rounded-xl shadow-card bg-white max-w-form w-full p-10">
        ...
        <Text className="form-title mb-4">Login to your account</Text>
        ...
        <div className="w-full flex justify-between items-center mb-4 mt-1">
          ...
          <Text className="text-primary text-sm animate-bigger cursor-pointer">
            Forgot password
          </Text>
        </div>
        ...
        <Button purpose="google" onClick={() => console.log("google")}>
